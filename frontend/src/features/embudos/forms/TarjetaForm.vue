  ...
  <div class="space-y-4">
    ...
    <div>
      ...
      <div class="grid grid-cols-2 gap-3">
        <input v-model="contacto.nombre1" @blur="tocar('contacto')" placeholder="Primer nombre" class="w-full h-10 px-4 rounded-lg border bg-slate-50 dark:bg-slate-900 text-[12px] text-slate-900 dark:text-slate-100 outline-none focus:bg-white dark:focus:bg-slate-800 transition-all" :class="fieldStateClass(esVisible('contacto') && (!!errors.contacto || apellidoFaltante), esVisible('contacto') && !errors.contacto && !apellidoFaltante && !!draft.contacto, 'border-slate-200 dark:border-slate-600 focus:border-[#2447F9]')" />
        ...
        <input v-model="contacto.apellido1" @blur="tocar('contacto')" placeholder="Primer apellido" class="w-full h-10 px-4 rounded-lg border bg-slate-50 dark:bg-slate-900 text-[12px] text-slate-900 dark:text-slate-100 outline-none focus:bg-white dark:focus:bg-slate-800 transition-all" :class="fieldStateClass(esVisible('contacto') && (!!errors.contacto || apellidoFaltante), esVisible('contacto') && !errors.contacto && !apellidoFaltante && !!draft.contacto, 'border-slate-200 dark:border-slate-600 focus:border-[#2447F9]')" />
    ...
    <div class="grid grid-cols-2 gap-4">
      ...
      <div>
        <label class="block text-[11px] font-bold text-body mb-1.5 uppercase tracking-wide">Seguimiento</label>
        <FechaInput v-model="draft.seguimiento" />
      </div>
    </div>
    <div>
