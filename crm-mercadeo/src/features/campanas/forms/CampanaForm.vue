...
<template>
  <div class="space-y-4">
    <div>
      ...
      <input v-model="draft.nombre" placeholder="Ej: Bienvenida Plan Liga Q3" class="w-full h-10 px-4 rounded-lg border border-slate-200 bg-slate-50 text-[12px] outline-none focus:border-[#2447F9] focus:bg-white transition-all" />
    </div>
    <div>
